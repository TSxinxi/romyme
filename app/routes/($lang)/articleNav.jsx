            ...
            id == 0 ? <div className="shopify-policy__container">
              ...
              <div className="shopify-policy__body">
                <div className="rte">
                  ...
                  <div style={{ textAlign: "center" }}>Prin furnizarea datelor dvs. personale, sunteți de acord ca aidoria.com să utilizeze datele colectate pentru a ne îndeplini obligațiile față de dvs. și pentru a vă oferi serviciile la care v-ați așteptat.</div>
                  <div style={{ textAlign: "center" }}><br /></div>
                  <div style={{ textAlign: "center" }}>Avem nevoie de datele dumneavoastră personale în următoarele scopuri:</div>
                  <div style={{ textAlign: "center" }}><br /></div>
                  <div style={{ textAlign: "center" }}>- Creați-vă contul personal pe aidoria.com (de exemplu, numele și adresa dvs. de e-mail)</div>
                  <div style={{ textAlign: "center" }}><br /></div>
              ...
              id == 1 ? <div className="shopify-policy__container">
                ...
                <div className="shopify-policy__body">
                  <div className="rte">
                    ...
                    <h3 style={{ textAlign: "center" }}>Pentru a beneficia de restituirea banilor, te rugam sa ai in vedere urmatoarele conditii de returnare a produselor:</h3>
                    ...
                    <div style={{ textAlign: "center" }}><em>- instiintarea pentru returnarea produselor sa fie facuta in termen de<span>&nbsp;</span><strong>7 zile calendaristice de la momentul primirii coletului</strong></em></div>
                    ...
                    <div style={{ textAlign: "center" }}>- tă rugăm să ne informați despre intenția dumneavoastră de a returna numărul comenzii, detaliile articolului returnat, o fotografie a articolului și numărul contului bancar de rambursare la

                      <p><strong>aidoriastore@gmail.com</strong></p>
                    ...
                    <div style={{ textAlign: "center" }}>- costul de retur este de<span>&nbsp;</span><strong>30 LEI</strong><span>&nbsp;</span>si se va scadea din valoarea sumei de returnat</div>
                    <div style={{ textAlign: "center" }}><br /></div>
                  ...
                  <div className="shopify-policy__body">
                    <div className="rte">
                      ...
                      <div className="p1" style={{ textAlign: "center" }}>
                        <span className="s1">NOTĂ: Orice alte drepturi care există în legătură cu site-ul aidoria.com</span><span className="s1">&nbsp;sunt supuse legilor privind drepturile de autor și mărcile comerciale. Nu puteți reproduce pentru uz public sau comercial fără permisiunea scrisă expresă. Dacă doriți să reproduceți, să stocați, să transmiteți sau să utilizați în alt mod conținutul care apare pe site-ul nostru web, vă rugăm să ne contactați prin e-mail: </span>
                      </div>
                      <div className="p1" style={{ textAlign: "center" }}>
